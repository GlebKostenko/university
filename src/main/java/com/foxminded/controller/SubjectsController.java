...
public class SubjectsController {
    ...
    @PostMapping()
    public String save(@ModelAttribute("subject") SubjectDTO subjectDTO){
    ...
    @PatchMapping("/{id}")
    public String update(@ModelAttribute("subject") SubjectDTO subjectDTO,@PathVariable("id") Long id){
